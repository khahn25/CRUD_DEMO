...
const UpdateTaskScreen = ({ navigation }) => {
    ...
    const taskData = navigation.getParam("taskData")
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.mainText}>Cập nhật công việc</Text>
            ...
            <TouchableOpacity style={styles.button} onPress={updateTaskAction}>
                <Text>Cập nhật công việc</Text>
            </TouchableOpacity>
